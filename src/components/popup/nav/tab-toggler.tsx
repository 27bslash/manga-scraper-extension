      ...
      {props.checked.length === 0 && filteredData.length > 0 && (
        ...
        >
          <Tab
            ...
            label="Unread"
            onClick={() => props.handleClick(false, "toggleView")}
          />
          <Tab
            sx={{ color: "#fff !important" }}
            label="All series"
            onClick={() => props.handleClick(true, "toggleView")}
          />
          <Tab
            sx={{ color: "#fff !important" }}
            label="Add New"
            onClick={() => props.handleClick(true, "addNew")}
          />
        </Tabs>
      )}
      {props.checked.length === 0 && filteredData.length === 0 && (
      ...
      {props.checked.length > 0 && props.showAll && (
        ...
        >
          <Tab
            ...
            className="align-right"
            label="read"
            onClick={() => props.updateRead(true)}
          />
          <Tab
            sx={{ color: "#fff !important" }}
            className="align-right"
            label="un-read"
            onClick={() => props.updateRead(false)}
          />
          <Tab
            sx={{ color: "#fff !important" }}
            label="Delete"
            onClick={() => props.handleDelete(-1)}
          />
        </Tabs>
      )}
      {props.checked.length > 0 && !props.showAll && (
